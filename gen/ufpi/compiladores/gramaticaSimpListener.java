...
public interface GramaticaSimpListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link GramaticaSimpParser#comando}.
	 * @param ctx the parse tree
	 */
	void enterComando(GramaticaSimpParser.ComandoContext ctx);
	/**
	 * Exit a parse tree produced by {@link GramaticaSimpParser#comando}.
	 * @param ctx the parse tree
	 */
	void exitComando(GramaticaSimpParser.ComandoContext ctx);
	/**
